...
def check_command(args):
    ...
    # Check project files
    project_root = Path(__file__).parent.parent  # Get the root directory
    ai_factory_dir = Path(__file__).parent  # Get ai_factory directory
    
    project_files = {
        "ai_factory/api": ai_factory_dir / "api",
        "ai_factory/cli.py": ai_factory_dir / "cli.py", 
        "requirements.txt": project_root / "requirements.txt",
        "setup.py": project_root / "setup.py",
        "ai_factory/config.py": ai_factory_dir / "config.py"
    }
    
    missing_files = [name for name, path in project_files.items() if not path.exists()]
